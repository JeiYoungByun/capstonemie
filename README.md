...
> **요지:** 선행은 대체로 **하드웨어 통합**(하프미러/조명/센서) 또는 **센싱/포즈/인식**에 집중되어 있습니다. **Aura의 독창성은 “온디바이스 예측 엔진 + Generative Layout + 상황인지 오케스트레이터”라는 **결정·정책 레이어**에 있습니다.**
...
* **회피·차별 포인트**
  ...
  * **상황인지 오케스트레이터**: 역할(Owner/Guest/Kid), 권한, 실시간 상황(방문/이벤트)을 입력으로, 위젯 단위 접근 제어, 게스트 마스킹, 페르소나 자동 전환, 공정성 스케줄링을 수행하는 **온디바이스 정책 엔진.**
